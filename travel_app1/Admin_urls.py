...
urlpatterns = [
    ...
    path('add_fill_exclusion/', admin_addFill_exclusion, name = "admin_add_fill_exclusion"),
    ...
    path('view_fill_exclusion/<int:pk>', admin_viewFill_exclusion, name = "admin_view_fill_exclusion"),
    ...
    path('delete_fill_exclusion/<int:pk>', delete_adminFillExclusion, name = "admin_Fill_exclusion_delete"),
